...
public final class Red9Artifact extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action sortIndexer = packet -> {
            ...
            indexer.readIndexer(indexerZero, colors);
        ...
        Action loadGreen = packet -> {
            ...
            return Math.abs(spinnyTarget-indexer.getSpinnyPose())>5;
        };
