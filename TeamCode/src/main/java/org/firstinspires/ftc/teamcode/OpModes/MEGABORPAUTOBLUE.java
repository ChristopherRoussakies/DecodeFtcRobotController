...
@Autonomous
public class MEGABORPAUTOBLUE extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        Pose2d beginPose = new Pose2d(0, 0, Math.toDegrees(0));
        ...
        TrajectoryActionBuilder shoot1 = drive.actionBuilder(beginPose)
                .strafeToLinearHeading(new Vector2d(7, -25), Math.PI/1.65);//-x=backwards was -19

        TrajectoryActionBuilder preEat1 = shoot1.endTrajectory().fresh()
                .strafeToLinearHeading(new Vector2d(-15, -46), Math.PI/1.267); //(-39, 27)

        TrajectoryActionBuilder eat1 = preEat1.endTrajectory().fresh()
                .strafeToConstantHeading(new Vector2d(-29, -33));
        ...
        TrajectoryActionBuilder shoot2 = eat1.endTrajectory().fresh()
                .strafeToLinearHeading(new Vector2d(7, -25), Math.PI/1.65);

        TrajectoryActionBuilder preEat2 = shoot2.endTrajectory().fresh()
                .strafeToLinearHeading(new Vector2d(-30, -62), Math.PI/1.267);
        ...
        Action intakeSecondStageOff = packet -> {
            index.secondIntakeStageOff();
            return false;
        };
        ...
        Action extrapolateFromIncompleteData = packet -> {
            if (colors[0]==2 && colors[1]==2){
                colors[2]=1;
            } else if (colors[0]==2 && colors[2]==2) {
                colors[1]=1;
            }
            else if (colors[1]==2 && colors[2]==2){
                colors[0]=1;
            }
            return false;
        };
